...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let n_id = new_id () in
    evt := {id = n_id; action = listener} :: !evt ;
    n_id
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    List.iter (fun l -> l.action arg) !evt
...
let id_list = [add_listener newswire fakeNewsNetwork; add_listener newswire buzzFake] ;;
...
List.iter (fun cur_id -> remove_listener newswire cur_id) id_list ;;
